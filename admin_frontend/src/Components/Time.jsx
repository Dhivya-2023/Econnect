...
//           `http://127.0.0.1:8000/attendance/?date=${formattedDate}`
//         );
//         const filteredData =
    ...
    <div className="flex bg-[#6d9eeb] bg-gradient-to-b from-blue-400 to-indigo-800">
      ...
      <div className="container my-6 mx-6 bg-white rounded-3xl p-10">
        ...
        <div className="mt-4 flex justify-end">
                      <button className="py-1 px-3 bg-blue-500 hover:bg-blue-400 text-white text-sm font-inter rounded-full shadow-lg" onClick={downloadExcel}>
