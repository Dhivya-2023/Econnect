...
//     } else if (!selectedDate && (leaveType === "Sick Leave" || leaveType === "Casual Leave")) {
//       setValidationMessage("Select a valid date");
//     } else if (!reason.trim() && (leaveType === "Sick Leave" || leaveType === "Casual Leave")) {
//       setValidationMessage("Enter a valid reason");
//     } else {
//       let newLeave;
      
//       if (leaveType === "Sick Leave" || leaveType === "Casual Leave") {
...
//       // Disable Fridays, Mondays, and Sundays for Sick Leave
//       return (
//         current.isSameOrAfter(today) &&
//         current.day() !== 0 &&
//         current.day() !== 1 &&
//         current.day() !== 5
//       );
...
//       // Disable Sundays for Casual Leave
...
//             </div>
//           </div>
//           {(leaveType === "Sick Leave" || leaveType === "Casual Leave") && (
//             <div>
...
// }
  ...
  const isValidDate = (current, leaveType) => {
    ...
    else if (leaveType === "Casual Leave"  || leaveType === "Permission") {
      // Disable Sundays for Casual Leave
      return current.isSameOrAfter(today) && current.day() !== 0;
    }
    else if (leaveType === "Other Leave") {
